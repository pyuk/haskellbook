...
/* package vigIO-0.1.0.0 */
#define VERSION_vigIO "0.1.0.0"
#define MIN_VERSION_vigIO(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "vigIO-0.1.0.0-ItaPjwKPVuJKEAkQOAuq1e"

#define CURRENT_PACKAGE_KEY "vigIO-0.1.0.0-ItaPjwKPVuJKEAkQOAuq1e"
